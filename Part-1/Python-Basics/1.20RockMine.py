...
sonar_data=pd.read_csv('Part-1/Python-Basics/1.20sonar data.csv')
print(sonar_data.head()) # header=None
...
# seperate the data and labels(like rock,mine)
...
# reshaping the np array as we predicting for one instance
